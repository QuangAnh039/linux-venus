...
#ifndef CA_KERNEL_HOOK_API_VENUS_H
#define CA_KERNEL_HOOK_API_VENUS_H

/***************************************************************************
 * ca_kernel_hook_api_venus.h
 *
...
struct kernel_hook_ops {
	int (*kho_l3_intf_add)(u16 device_id, struct net_device *dev,
			       struct __ca_ip_address *ip_addr, u32 port_id,
			       u32 tunnel_id);
	...
	int (*kho_ip6tnl_add)(u16 device_id, int ifindex,
			      struct __ip6_tnl_parm *p, u32 *ret_tunnel_id);
	...
	int (*kho_nat46_add)(u16 device_id, int ifindex,
			     struct ca_nat46_khook_rule_pair *p, u32 *ret_tunnel_id);
...
#endif /* CA_KERNEL_HOOK_API_VENUS_H */
