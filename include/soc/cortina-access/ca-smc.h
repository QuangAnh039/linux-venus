#ifndef __CORTINA_ACCESS_SMC_H__
#define __CORTINA_ACCESS_SMC_H__
...
/* OTP */
/* FID for CA_SVC_OTP */
#define CA_SVC_OTP_ROTPK_STAT		(SIP_SVC_CALL|CA_SVC_OTP|0)
#define CA_SVC_OTP_ROTPK_GET		(SIP_SVC_CALL|CA_SVC_OTP|1)
#define CA_SVC_OTP_ROTPK_SET		(SIP_SVC_CALL|CA_SVC_OTP|2)
#define CA_SVC_OTP_KEY1_GET			(SIP_SVC_CALL|CA_SVC_OTP|3)
#define CA_SVC_OTP_KEY2_GET			(SIP_SVC_CALL|CA_SVC_OTP|4)
#define CA_SVC_OTP_KEY3_GET			(SIP_SVC_CALL|CA_SVC_OTP|5)
#define CA_SVC_OTP_PHY_PARAM_GET	(SIP_SVC_CALL|CA_SVC_OTP|6)

#define CA_SMC_K1_FETCH(addr)		ca_smc_call(CA_SVC_OTP_KEY1_GET, (unsigned long)addr, 0, 0, 0)	/* Pass any address except 0 */
#define CA_SMC_K2_FETCH(addr)		ca_smc_call(CA_SVC_OTP_KEY2_GET, (unsigned long)addr, 0, 0, 0)	/* Pass any address except 0 */
#define CA_SMC_K3_FETCH(addr)		ca_smc_call(CA_SVC_OTP_KEY3_GET, (unsigned long)addr, 0, 0, 0)	/* Pass any address except 0 */
#define CA_SMC_GET_GPHY_PARAM(addr)	ca_smc_call(CA_SVC_OTP_PHY_PARAM_GET, (unsigned long)addr, 0, 0, 0)	/* Pass any address except 0 */
...
#define CA_SVC_GET_ROM_VERSION	(SIP_SVC_CALL|CA_SVC_MISC|4)
#define CA_SVC_GET_CHIP_ID		(SIP_SVC_CALL|CA_SVC_MISC|5)
...
#define CA_SMC_CALL_REG_READ(addr)	ca_smc_call(CA_SVC_REG_READ, (unsigned long) addr, 0, 0, 0)
#define CA_SMC_CALL_REG_WRITE(addr, val) 	ca_smc_call(CA_SVC_REG_WRITE, (unsigned long)addr, val, 0, 0)
#define CA_SMC_CALL_REG_READ64(addr)	ca_smc_call(CA_SVC_REG_READ, (unsigned long)addr, 0, 1, 0)
#define CA_SMC_CALL_REG_WRITE64(addr, val) 	ca_smc_call(CA_SVC_REG_WRITE, (unsigned long)addr, val, 1, 0)
#define CA_SMC_CALL_REG_BIT_SET(addr, bit)  	ca_smc_call(CA_SVC_REG_SET_BIT, (unsigned long)addr, bit, 0, 0)
#define CA_SMC_CALL_REG_BIT_CLEAR(addr, bit)  	ca_smc_call(CA_SVC_REG_CLR_BIT, (unsigned long)addr, bit, 0, 0)
#define CA_SMC_CALL_ROM_VERSION()	ca_smc_call(CA_SVC_GET_ROM_VERSION, 0x12345678, 0, 0, 0)	/* Pass any address except 0 */
#define CA_SMC_CALL_CHIP_ID()		ca_smc_call(CA_SVC_GET_CHIP_ID, 0x12345678, 0, 0, 0)	/* Pass any address except 0 */
