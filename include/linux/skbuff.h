...
#ifdef CONFIG_ARCH_CORTINA_ACCESS
...
#ifdef CONFIG_ARCH_CORTINA_ACCESS
	struct ca_offload_info	ca_offload_info;
	__s32			lspid; /* negative means invalid */
