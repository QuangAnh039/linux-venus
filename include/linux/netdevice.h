...
#define TSO_MAX_SEGS		U16_MAX
	...
	bool	ca_intf_id_valid;
	u32	ca_intf_id;

	bool	ca_parent_intf_id_valid;
	u32	ca_parent_intf_id;

	bool	ca_tunnel_id_valid;
	u32	ca_tunnel_id;

	/* IPSec-only info.
	 * IPSec doesn't create a new net_device; it uses same net_device.
	 */
	bool	ca_ipsec_intf_id_valid;
	u32	ca_ipsec_intf_id;

	bool	ca_ipsec_parent_intf_id_valid;
	u32	ca_ipsec_parent_intf_id;

	bool	ca_ipsec_tunnel_id_valid;
	u32	ca_ipsec_tunnel_id;
#endif
};
