...
#define SSCPLL_CTRL0	(0x0)
  #define REG_OC_EN	(0x1 << 26)
  #define FLAG_INIT	(0x1 << 13)
  #define PHRT0		(0x1 << 1)
...
#define SSCPLL_CTRL3	(0xC)
  ...
  #define CLK_EN_SD30	(0x1 << 4)
#define SSCPLL_CTRL4	(0x10)
  #define EN_SSC	(1 << 25)
#define SSCPLL_CTRL5	(0x14)

#define BLK_RESET	(0)
  #define RESET_SD	(0x1 << 24)
#define BLK_RESET_EXT	(8)
  #define EN_SD		(0x1 << 18)
...
#define EMMC_PLL_DEBUG1             ( 0x0a4 )
  #define PLL_DEBUG1_CLKRDY (1 << 9)
...
#define CRC_CLK_SSC		(0x0 << 4)
#define CRC_CLK_VP0		(0x1 << 4)
#define CRC_CLK_VP1		(0x2 << 4)
#define PUSH_CLK_SSC		(0x0 << 8)
#define PUSH_CLK_VP0		(0x1 << 8)
#define PUSH_CLK_VP1		(0x2 << 8)
#define SAMPLE_CLK_SSC		(0x0 << 12)
#define SAMPLE_CLK_VP0		(0x1 << 12
#define SAMPLE_CLK_VP1		(0x2 << 12)
...
/* SAMPLE_POINT_CTL */
#define SP_SDR_DEFAULT			0x0
#define SP_DDR_DEFAULT			0x0
#define SP_SDR_DELAY			(0x1 << 3)
#define SP_DDR_CMD_DELAY		(0x1 << 4)
#define SP_DDR_DATA_DELAY		(0x1 << 6)

/* PUSH_POINT_CTL */
#define PP_SDR_DEFAULT			0x0
#define PP_DDR_DEFAULT			0x0
#define PP_SDR_AHEAD			(0x1 << 4)
#define PP_DDR_CMD_AHEAD		(0x1 << 5)
#define PP_DDR_DATA_AHEAD		(0x1 << 6)
