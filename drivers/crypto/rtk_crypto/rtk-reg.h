#ifndef __RTK_CRYPTO_REG_H__
#define __RTK_CRYPTO_REG_H__
 ...
 */
typedef struct {                                /*!< (@ 0x50070000) CRYPTO Structure */   // pshunag
  ...
  union {
    __IOM uint32_t ipscsr_err_stats_reg;        /*!< (@ 0x0000001C) IPSec Command/Status Register, for error status */ //pshuang
...
#else
  __IM  uint32_t  RESERVED4[115]; // between 0x0000034 to 0x00000200 //pshuang
#endif
